...
/* ═══════════════════════════════════════════════════
   AdminKnockoutCard — card pra definir os times de um
   match de mata-mata que ainda está com placeholders
   ═══════════════════════════════════════════════════ */

export default function AdminKnockoutCard({ match, teams, now, onSave }) {
  ...
  const handleSave = async () => {
    ...
    if (updateError) {
      console.error('Erro ao definir confronto:', updateError)
    ...
    setSaving(false)
    onSave(match.id, parseInt(homeId), parseInt(awayId))
  }
  ...
  return (
    <div className="bg-gray-800/80 rounded-xl border border-gray-700/40 overflow-hidden">
      ...
      <div className="p-4 space-y-3">
        ...
        {/* Confronto atual (placeholder × placeholder) */}
        ...
        {/* Feedback + botão */}
        <div className="pt-1 flex items-center justify-between gap-2 min-h-[28px]">
